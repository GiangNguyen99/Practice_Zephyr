...
struct _isr_table_entry __sw_isr_table _sw_isr_table[86] = {
	...
	{(const void *)0x8003e80, (ISR)0x8000f1d}, /* 6 */
	{(const void *)0x8003e7e, (ISR)0x8000f1d}, /* 7 */
	{(const void *)0x8003e7c, (ISR)0x8000f1d}, /* 8 */
	{(const void *)0x8003e7a, (ISR)0x8000f1d}, /* 9 */
	{(const void *)0x8003e78, (ISR)0x8000f1d}, /* 10 */
	...
	{(const void *)0x8003e76, (ISR)0x8000f1d}, /* 23 */
	...
	{(const void *)0x8003974, (ISR)0x800335b}, /* 38 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 39 */
	{(const void *)0x8003e74, (ISR)0x8000f1d}, /* 40 */
