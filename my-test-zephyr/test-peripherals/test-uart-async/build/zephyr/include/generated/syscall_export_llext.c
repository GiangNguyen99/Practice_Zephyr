...
extern __weak ALIAS_OF(no_handler) void * const z_impl_reset_status;
extern __weak ALIAS_OF(no_handler) void * const z_impl_reset_line_assert;
extern __weak ALIAS_OF(no_handler) void * const z_impl_reset_line_deassert;
extern __weak ALIAS_OF(no_handler) void * const z_impl_reset_line_toggle;
